...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="exam",
            index=models.Index(
                fields=["is_active", "created_at"], name="exams_exam_is_acti_2efcf6_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="result",
            constraint=models.UniqueConstraint(
                fields=("student", "exam"), name="unique_student_exam_attempt"
            ),
        ),
        migrations.AddIndex(
            model_name="result",
            index=models.Index(
                fields=["exam", "attempted_at"], name="exams_resul_exam_id_474359_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="result",
            index=models.Index(
                fields=["student", "attempted_at"], name="exams_resul_student_801c6a_idx"
            ),
        ),
        migrations.AddConstraint(
