...
urlpatterns = [
    ...
    path("admin-panel/exams/<int:exam_id>/delete/", views.admin_exam_delete, name="admin_exam_delete"),
    path("admin-panel/exams/<int:exam_id>/toggle/", views.admin_exam_toggle, name="admin_exam_toggle"),
    path("admin-panel/exams/<int:exam_id>/questions/", views.admin_question_list, name="admin_question_list"),
    path("admin-panel/exams/<int:exam_id>/questions/add/", views.admin_question_create, name="admin_question_create"),
    path("admin-panel/questions/<int:question_id>/edit/", views.admin_question_edit, name="admin_question_edit"),
    path("admin-panel/questions/<int:question_id>/delete/", views.admin_question_delete, name="admin_question_delete"),
